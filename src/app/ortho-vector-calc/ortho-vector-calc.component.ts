...
@Component({
  selector: 'app-ortho-vector-calc',
  templateUrl: './ortho-vector-calc.component.html',
  styleUrls: ['./ortho-vector-calc.component.css']
})
export class OrthoVectorCalcComponent implements OnInit {
  ...
  solve_dot_prod(){
    if(this.a_2_1 != null && this.a_2_2 != null && this.b_2_1 != null && this.b_2_2 != null){
      if(this.TwoDi == true){
        ...
        if(dotprod != 0){
          this.final_answer = "Vectors aren't orthogonaly";
        }else{
          this.final_answer = "Vectors are orthogonaly";
        }
      }
    }
    if(this.a_2_1 == null || this.a_2_2 == null || this.b_2_1 == null || this.b_2_2 == null){
